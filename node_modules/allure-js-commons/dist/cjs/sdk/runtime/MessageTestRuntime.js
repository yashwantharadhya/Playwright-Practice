...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint @typescript-eslint/require-await: off */
...
class MessageTestRuntime extends BaseMessageTestRuntime {
  attachment(name, content, options) {
    var _this16 = this;
    return _asyncToGenerator(function* () {
      var bufferContent = typeof content === "string" ? Buffer.from(content, options.encoding) : content instanceof Uint8Array ? Buffer.from(content) : content;
