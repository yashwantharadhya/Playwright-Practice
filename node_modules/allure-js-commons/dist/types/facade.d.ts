...
export declare const attachment: (name: string, content: Buffer | Uint8Array | string, options: ContentType | string | AttachmentOptions) => PromiseLike<void>;
export declare const globalAttachment: (name: string, content: Buffer | Uint8Array | string, options: ContentType | string | AttachmentOptions) => PromiseLike<void>;
export declare const globalAttachmentPath: (name: string, path: string, options: ContentType | string | Omit<AttachmentOptions, "encoding">) => PromiseLike<void>;
export declare const globalError: (details: StatusDetails) => PromiseLike<void>;
