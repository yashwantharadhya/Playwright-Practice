...
var AllureReporter = exports.AllureReporter = /*#__PURE__*/function () {
  ...
  return _createClass(AllureReporter, [{
    ...
    value: function onTestBegin(test) {
      ...
      result.labels.push((0, _reporter.getPackageLabel)(metadata.testFilePath));
      result.labels.push({
        name: "titlePath",
      ...
      if (isHookStep) {
        ...
        if (!stack) {
          ...
          var rootHookStep = _objectSpread(_objectSpread({}, (0, _reporter.createStepResult)()), {}, {
            name: isBeforeHookDescendant ? _utils.BEFORE_HOOKS_ROOT_STEP_TITLE : _utils.AFTER_HOOKS_ROOT_STEP_TITLE,
            start: step.startTime.getTime(),
            stage: _allureJsCommons.Stage.RUNNING,
            uuid: (0, _reporter.randomUuid)()
          });
    ...
    value: function getStaticTestMetadata(test) {
      ...
      var normalizedAbsoluteFile = _nodePath["default"].normalize(test.location.file);
      var normalizedRelativeFile = _nodePath["default"].normalize(testFilePath);
      ...
      if (suiteTitles.length > 0 && fileTitleCandidates.has(_nodePath["default"].normalize(suiteTitles[0]))) {
        suiteTitles = suiteTitles.slice(1);
      }
